...
var ConnectionManager = /** @class */ (function () {
    ...
    ConnectionManager.prototype.setEventHandlers = function (client) {
        ...
        if (client == "1") {
            ...
            this.datachannel_client_1.onopen = function (event) {
                _this.handleDataChannelOpen(event, "1");
            };
            this.datachannel_client_1.onmessage = function (event) {
                _this.handleDataChannelMessageReceived(event, "1");
            };
            this.datachannel_client_1.onerror = this.handleDataChannelError;
            this.datachannel_client_1.onclose = function (event) {
                _this.handleDataChannelClose("1");
            };
        }
        else if (client == "2") {
            ...
            this.RTCPeerConnectionObject_client_2.onicecandidate = function (event) {
                ...
                _this.RTCPeerConnectionObject_client_2.ondatachannel = function (event) {
                    _this.datachannel_client_2 = event.channel;
                    _this.datachannel_client_2.onopen = function (event) {
                        _this.handleDataChannelOpen(event, "2");
                    };
                    _this.datachannel_client_2.onmessage = function (event) {
                        _this.handleDataChannelMessageReceived(event, "2");
                    };
                    _this.datachannel_client_2.onerror = _this.handleDataChannelError;
                    _this.datachannel_client_2.onclose = function (event) {
                        _this.handleDataChannelClose("2");
                    };
                };
            };
        }
    ...
    ConnectionManager.prototype.handleDataChannelMessageReceived = function (event, client) {
    ...
    ConnectionManager.prototype.handleDataChannelClose = function (client) {
...
var RTCShareManager = /** @class */ (function () {
    function RTCShareManager(options) {
        ...
        this.conMan.stopLiveMode = function (args) {
            _this.stopLiveMode(args.restart);
        };
    }
    ...
    RTCShareManager.prototype.checkMessage = function (chatInputValue, client) {
    ...
    RTCShareManager.prototype.sendMessage = function (chatInputValue, client) {
        if (client == "1") {
    ...
    RTCShareManager.prototype.checkKey = function (key, client, element) {
        if (key == "13" && client == "1") {
    ...
    RTCShareManager.prototype.createMyMessage = function (message, client) {
